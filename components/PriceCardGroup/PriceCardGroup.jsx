 ...
 function PriceCardGroup({ currentPrices, performance }) {
  return (
    <div className="flex flex-col gap-3 pt-1 pb-2 border h-100 w-45 dark:bg-deepBlack rounded-xl border-deepBlack">

        <h3 className="pl-2 dark:text-white">Current product retail prices</h3>
      ...
      {Object.entries(currentPrices).map(([key, value]) => {
        ...
        return (
            <div key={key} className="flex items-center justify-between py-1.5 pl-2 pr-1 border-b w-100 border-darkBg text-15px">
